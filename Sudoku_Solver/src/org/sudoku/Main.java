...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        /* for (int i=0; i<9; i++) {
            System.out.println(board2.board_cells[7][3].possibleValues[i]);
        }

         */
        Board solvedBoard = board.deepCopy();
        System.out.println(solvedBoard == null);
        solvedBoard = solvedBoard.solveBoard();
        System.out.println(solvedBoard);
        System.out.println(solvedBoard.isCompletelySolved());
        // board2.setPossibleValueIfUnique(board2.board_cells[7][3]);
        /* for (int i=0; i<9; i++) {
            System.out.println(board2.board_cells[7][3].possibleValues[i]);
        }
        ...
        for (int i=0; i<9; i++) {
            System.out.println(board.board_cells[7][3].possibleValues[i]);
        }

         */
        //TODO for makeTestBoard4, the setPossibleValueIfUnique should set board2.board_cells[7][3] to 6
        // System.out.println(board2.board_cells[7][3].getIsSolved());
